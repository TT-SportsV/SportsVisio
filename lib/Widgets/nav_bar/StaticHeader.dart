...
class StaticHeader extends StatefulWidget {
  var isFromDashBoard;
  var title;
  StaticHeader({this.isFromDashBoard, this.title});
  @override
  _StaticHeaderState createState() => _StaticHeaderState();
}

class _StaticHeaderState extends State<StaticHeader> {
  ...
  Widget build(BuildContext context) {
    ...
    return StaticHeader(size);
  }

  Container StaticHeader(Size size) {
    return Container(
