...
class LifeLongResultView extends StatefulWidget {
  const LifeLongResultView({Key? key}) : super(key: key);

  @override
  _LifeLongResultViewState createState() => _LifeLongResultViewState();
}

class _LifeLongResultViewState extends State<LifeLongResultView> {
